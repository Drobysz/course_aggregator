...
interface StarIconProps extends DetailedHTMLProps<HTMLAttributes<SVGSVGElement>, SVGSVGElement>{
    fill?: string;
    key: number;
    className: string;
}

const StarIcon: FC<StarIconProps> = ({fill="#E2E2E2", className, ...props})=>{
    return (
        <svg className={className} {...props} width="20" height="20" viewBox="0 0 20 20" fill={fill} xmlns="http://www.w3.org/2000/svg">
