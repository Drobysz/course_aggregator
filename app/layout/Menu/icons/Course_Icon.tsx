...
interface CourseIconProps extends DetailedHTMLProps<HTMLAttributes<SVGSVGElement>, SVGSVGElement>{
    fill?: string;
    key?: number;
    className?: string;
};
...
// #7653FC
const CourseIcon: FC<CourseIconProps> = ({fill="#787D85", className='none', ...props})=>{
    return (
        <svg className={className} {...props}  width="24" height="24" viewBox="0 0 24 24" fill={fill} xmlns="http://www.w3.org/2000/svg">
