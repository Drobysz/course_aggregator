...
const ArrowIcon: FC<ArrowIconProps> = ({className, width="6", height="10"})=>{
    return (
        <svg className={className} width={width} height={height} viewBox="0 0 6 10" fill='#3B434E' xmlns="http://www.w3.org/2000/svg">
